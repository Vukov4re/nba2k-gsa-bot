  ...
  try {
    if (i.isChatInputCommand()) {
      ...
      if (i.commandName === 'setuproles') {
        await i.reply({ content: 'Lege Rollen an…', ephemeral: true });
        ...
        await i.followUp({ content: '✅ Rollen-Buttons erstellt!', ephemeral: true });
      }
      return;
    }
    ...
    if (i.isButton()) {
      ...
      if (member.roles.cache.has(role.id)) {
        ...
        await i.reply({ content: `✅ Rolle ${roleName} hinzugefügt.`,
